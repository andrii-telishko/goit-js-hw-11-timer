  ...
  _createClass(CountDown, [{
    ...
    value: function getCountDown() {
      ...
      setInterval(function () {
        ...
        var time = targetDate - currentTime;

        var _CountDown = _this.getTimeComponents(time);

        _this.onTick(_CountDown);
      }, 1000);
    }
  }, {
    key: "startTime",
...
function upDateTimer(_ref2) {
  var days = _ref2.days,
      hours = _ref2.hours,
      mins = _ref2.mins,
      secs = _ref2.secs;
  _refs.default.days.textContent = days;
  _refs.default.hours.textContent = hours;
  _refs.default.mins.textContent = mins;
  _refs.default.secs.textContent = secs;
}

timer.startTime();
},{"./refs.js":"refs.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
